		...
		try {
	        ...
	        if(user!=null) {
	           ...
	           hs.setAttribute("user", user);
	            try {
	               if(user.getType().equals("User")) FacesContext.getCurrentInstance().getExternalContext().redirect("userpage.xhtml");
                       if(user.getType().equals("Admin")) FacesContext.getCurrentInstance().getExternalContext().redirect("adminpage.xhtml");
                       if(user.getType().equals("IT")) FacesContext.getCurrentInstance().getExternalContext().redirect("itpage.xhtml");
